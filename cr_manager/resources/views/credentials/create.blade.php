...
@section('title', 'Add Credential - Password Manager')
...
<div class="space-y-6">
        ...
        <div class="px-4 py-5 sm:p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-gray-600">Create a new password credential</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Form -->
    <div class="bg-white overflow-hidden shadow rounded-lg">
        <form action="{{ route('credentials.store') }}" method="POST" class="px-4 py-5 sm:p-6">
            @csrf
